Below are the datasets joined  and source code used to produce the visualization. The final datasets used were **heavily cleaned and filtered** to reduce computational load. 
